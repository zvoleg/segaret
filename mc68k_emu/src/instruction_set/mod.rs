...
pub(in crate) mod instruction_meta_data_types;
pub(in crate) mod generators;
...
pub(in crate) trait InstructionProcess: InstructionBoxedClone + InstructionData {
    fn fetch_decode_instruction_data(&mut self, cpu: &mut Mc68k);
    fn disassembly(&self) -> String;
}

pub(in crate) trait InstructionBoxedClone {
...
pub(in crate) trait InstructionData {
...
pub(in crate)fn generate() -> Vec<Box<dyn InstructionProcess>> {
